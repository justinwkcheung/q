...
SuggestedSong.create(song_id: 1, playlist_id: 1, user_id: 1, name: 'wow')
...
SuggestedSong.create(song_id: 2, playlist_id: 1, user_id: 2, name: 'crap')
...
SuggestedSong.create(song_id: 3, playlist_id: 2, user_id: 3, name: 'mediocre')
